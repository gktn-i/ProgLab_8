$(document).ready(function () {
  ...
  var timeRangeControl = L.control({ position: "topright" });
    ...
    fetch("/Backend/map.php")
      ...
      .then((locations) => {
        ...
        var markers = locations.map(function (location) {
          ...
          fetch(
            "/Backend/get_total_store_statistics.php?storeID=" +
              location.storeID
          )
            .then((response) => response.json())
            .then((statistics) => {
              ...
              marker.on("click", function () {
                console.log(
                  `Fetching statistics for store ID: ${location.storeID}`
                );
                ...
                datasets: [
                  {
                    ...
                    data: data.customers.map((item) =>
                      parseFloat(item.totalCustomers)
                    ),
